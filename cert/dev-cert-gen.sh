...
openssl req -newkey rsa:4096 -nodes -keyout tls.key -out req.pem -subj "/C=HU/ST=Budapest/L=Budapest/O=Petifies/OU=Petifies/CN=petifies.com/emailAddress=vantoan.hk14@gmail.com"
