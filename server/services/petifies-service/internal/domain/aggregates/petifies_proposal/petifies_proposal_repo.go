...
type PetifiesProposalRepository interface {
	...
	GetByUserID(ctx context.Context, userID uuid.UUID) ([]*PetifiesProposalAggre, error)
	...
	GetByUserIDWithSession(ctx context.Context, userID uuid.UUID) ([]*PetifiesProposalAggre, error)
