...
type PetifiesProposalSessionClosedEvent models.PetifiesProposalEvent

func NewPetifiesProposalSessionClosedEvent(petifiesProposal *petifiesproposalaggre.PetifiesProposalAggre) PetifiesProposalSessionClosedEvent {
	return PetifiesProposalSessionClosedEvent{
		ID:                petifiesProposal.GetID(),
		UserID:            petifiesProposal.GetUserID(),
		PetifiesSessionID: petifiesProposal.GetPetifiesSessionID(),
		Status:            string(valueobjects.PetifiesProposalStatusSessionClosed),
